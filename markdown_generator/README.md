...
These .ipynb files are Jupyter notebook files that convert structured TSV data into individual markdown files that will be properly formatted for the academicpages template. The notebooks contain a lot of documentation about the process.
